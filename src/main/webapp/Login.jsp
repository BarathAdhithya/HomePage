  ...
  .carousel-inner > .item > a > img {
    ...
    position:relative;     
	 ...
	 margin:-42px 0px 0px 0px;
	  ...
	  border-color:gray;
	  border-width:10px;
	  background-image:url("http://static.tumblr.com/b9e8624d82036b77b1c62558b8ed573d/ptwzc0c/Zgbmykxpw/tumblr_static_black-and-white-eyes-cats-animals-cat-eyes-1920x1080-hd-wallpapers-animals-photo-cat-hd-wallpaper.jpg");
...
<%@ include file="Header.jsp" %>
    ...
    <div class="navbar-header">
     ...
     <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" style="margin-left:450px;">
        ...
        <li  class="active"> <a href="Login.jsp"><span class="glyphicon glyphicon-log-in"></span><span style="font-family:Comic Sans MS;">
        login</span></a></li>
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" style="margin:5px 0px 0px 495px;font-family:Comic Sans MS;background-color:gray;"data-target="#myModal">Login Here</button>
      ...
      <div class="modal-content">
        ...
        <div class="transbox">
          ...
          <h2 class="modal-title" style="margin-left:350px;
               font-family:serif;"><b>Login</b></h2>
  ...
  <form role="form">
	...
	<div class="ModalFooter">
          ...
          <button type="submit" style="margin-left:140px;background-color:darkgray;" class="btn btn-default"  data-dismiss="modal">Welcome</button>

...
<%@ include file="Header.jsp" %>
    ...
    <div class="navbar-header">
     ...
     <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" style="margin-left:450px;">
        ...
        login</span></a></li>
        <li class="active"><a href="AboutUs.jsp"><span style="font-family:Comic Sans MS;"> about</span></a></li>
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" style="margin:5px 0px 0px 610px;font-family:Comic Sans MS; background-color:gray;"data-target="#myModal">About</button>
      ...
      <div class="modal-content">
        ...
        <div class="transbox">
          ...
          <h2 class="modal-title" style="margin-left:350px;
               font-family:serif;"><b>AboutUs</b></h2>
               <p>A pet or companion animal is an animal kept primarily for a person's company or protection, 
                  as opposed to working animals, sport animals, livestock, and laboratory animals, which are 
                  kept primarily for performance, agricultural value, or research. The most popular pets are 
                  noted for their attractive appearances and their loyal or playful personalities.

                  Pets provide their owners (or guardians[1]) physical and emotional benefits. Walking a dog 
                  can supply both the human and pet with exercise, fresh air, and social interaction. Pets can 
                  give companionship to elderly adults who do not have adequate social interaction with other
                  people, as well as other people that are living alone. There is a medically approved class 
                  of therapy animals, mostly dogs or cats, that are brought to visit confined humans.
                  Pet therapy utilizes trained animals and handlers to achieve specific physical, social,
                  cognitive, and emotional goals with patients.</p>
